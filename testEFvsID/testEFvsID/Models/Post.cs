...
namespace testEFvsID.Models
{
    public class Post
    {
        ...
        [Display(Name = "Ảnh")]
        [Required(ErrorMessage = "Phải có ảnh thumbnail")]
        ...
        public bool HotNew { set; get; }
        [Display(Name = "Tin tức nhanh")]
        public bool FlashNew { set; get; }
        [Display(Name = "Slider")]
        public bool Slider { set; get; }
